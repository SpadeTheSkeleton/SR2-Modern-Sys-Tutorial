...
>
> First step will be to change **DPI settings**, right click **Sega Rally 2.exe** > **Properties** > **Compatibility** > **"Change high DPI settings"** > click the ☑ for **"override high DPI scaling behaviour"**
>
